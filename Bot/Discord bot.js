// I plan on making a file to auto register commands when changes are made and make it not be guild locked
const fs = require('fs')
...
for (const folder of CommandsFolder) {
    ...
    for (const file of CommandFiles) {
        ...
        if ('data' in command && 'execute' in command) {
            ...
            console.log(chalk.bgRedBright(`the command file at ${FilePath} doesnt have a required 'execute' or 'data' prop.`))
        }
    }
}
